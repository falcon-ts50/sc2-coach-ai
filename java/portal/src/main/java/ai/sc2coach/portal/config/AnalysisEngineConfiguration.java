...
public class AnalysisEngineConfiguration {
    ...
    @Bean
    ReplayAnalysisReader replayAnalysisReader() {
        return new ReplayAnalysisReader();
    }

    @Bean
    ReplayDomainMapper replayDomainMapper() {
        return new ReplayDomainMapper();
    }

    @Bean
    MatchContextEngine matchContextEngine() {
        return new MatchContextEngine();
    }

    @Bean
    TurningPointEngine turningPointEngine() {
        return new TurningPointEngine();
    }
    ...
    KnowledgeEngine knowledgeEngine() {
        return KnowledgeEngine.defaults();
    }

    @Bean
    CoachFeedEngine coachFeedEngine() {
        return new CoachFeedEngine();
    }

    @Bean
    EpisodeEngine episodeEngine() {
        return new EpisodeEngine();
    }

    @Bean
    ArgumentDeltaEngine argumentDeltaEngine() {
        return new ArgumentDeltaEngine();
    }
    ...
    @Bean
    CoachNarrativeEngine coachNarrativeEngine() {
        return new CoachNarrativeEngine();
    }
}
