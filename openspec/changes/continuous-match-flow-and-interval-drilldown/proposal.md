...
4. Add interval drilldown below the graphs:
   - combats inside the selected interval;
   - explicit empty state when no combats are detected;
...
6. If the interval contains combats, those combats appear in the drilldown.
